...
class FinetuningArguments(
    ...
    lambda_reg: float = field(
        default=1.0,
        metadata={"help": "Regularization strength for margin regularization."},
    )
    margin_target: float = field(
        default=1.82,
        metadata={"help": "Target margin value for regularization."},
    )
    margin_scaling: float = field(
        default=125.0,
        metadata={"help": "Scaling factor for margin regularization."},
    )
